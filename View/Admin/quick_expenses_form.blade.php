        ...
        <form
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="account_id" class="form-control aiz-selectpicker" data-live-search="true" required>
            ...
            <div class="form-group">
                ...
                <select name="payment_account_id" class="form-control aiz-selectpicker" data-live-search="true"
                    required>
